...
GUI:AddSettings(Language["General"], Language["Player"], Language["Unit Frames"], function(left, right)
	...
	left:CreateSwitch("unitframes-player-enable-resource", Settings["unitframes-player-enable-resource"], Language["Enable Resaource Bar"], Language["Enable the player combo points"], ReloadUI):RequiresReload(true)
...
GUI:AddSettings(Language["General"], Language["Raid"], function(left, right)
	...
	left:CreateDropdown("raid-column-anchor", Settings["raid-column-anchor"], {[Language["Left"]] = "LEFT", [Language["Right"]] = "RIGHT", [Language["Top"]] = "TOP", [Language["Bottom"]] = "BOTTOM"}, Language["New Column Anchor"], Language["Set where new columns should anchor to"], UpdateRaidColumnAnchor)
end)
